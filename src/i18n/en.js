export default {
  ...
  // Hot Potato Game
  hotPotatoGame: 'Hot Potato',
  hotPotatoSetupTitle: 'Hot Potato',
  hotPotatoSetupSubtitle: 'Pass the phone and say a word from the topic before it explodes.',
  hotPotatoDifficulty: 'Difficulty',
  hotPotatoDifficultyEasy: 'Easy',
  hotPotatoDifficultyMedium: 'Medium',
  hotPotatoDifficultyHard: 'Hard',
  hotPotatoDifficultyEasyDesc: '1.5 – 4 minutes',
  hotPotatoDifficultyMediumDesc: '40 sec – 2 minutes',
  hotPotatoDifficultyHardDesc: '20 – 60 seconds',
  hotPotatoCategories: 'Categories',
  hotPotatoCategoriesRandom: 'Random category each round',
  hotPotatoHowToPlay: 'How to Play',
  hotPotatoHowToPlay1: '1. A topic appears on screen. The first player says a related word.',
  hotPotatoHowToPlay2: '2. Press PASS and hand the phone to the next player.',
  hotPotatoHowToPlay3: '3. The timer is random: nobody knows when it explodes.',
  hotPotatoHowToPlay4: '4. Whoever holds the phone when it explodes loses a life.',
  hotPotatoHowToPlay5: '5. Words can\'t be repeated. A player with no lives is eliminated.',
  hotPotatoStartGame: 'Start',
  hotPotatoRound: 'Round',
  hotPotatoTopic: 'TOPIC',
  hotPotatoCurrentPlayer: 'It\'s',
  hotPotatoPass: 'PASS!',
  hotPotatoLivesLeft: 'Lives',
  hotPotatoExplosion: 'BOOM!',
  hotPotatoLostLife: 'lost a life',
  hotPotatoEliminated: 'Eliminated!',
  hotPotatoNextRound: 'Next Round',
  hotPotatoPlayAgain: 'Play Again',
  hotPotatoWinner: 'Winner!',
  hotPotatoWinnerMsg: 'is the last survivor',
  hotPotatoGameOver: 'Game Over',
  hotPotatoWordsSaid: 'Words said this round:',
  hotPotatoNoRepeat: 'Words can\'t be repeated!',
  hotPotatoEliminatedPlayers: 'Eliminated',
  hotPotatoAlivePlayers: 'In game',
  hotPotatoSelectCategories: 'Select one or more categories',
  hotPotatoCategoryAll: 'All',

  // Hot Potato categories
  hp_everyday:   '🏠 Everyday Life',
  hp_dark:       '💀 Dark Humor',
  hp_adult:      '🔞 Adults Only',
  hp_work:       '💼 Work',
  hp_absurd:     '🤡 Absurd',
  hp_party:      '🎉 Parties',
  hp_popculture: '🎬 Pop Culture',
